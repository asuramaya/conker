...
STAMP="$(date +%Y-%m-%d)"
LOG_PATH="$OUT_DIR/conker3_half_life_low_queue_${STAMP}.log"
...
echo "starting conker-3 low half-life queue" | tee "$LOG_PATH"

run_bridge 4 8.0 1500 42
run_bridge 8 8.0 1500 42
run_bridge 12 8.0 1500 42
run_bridge 16 8.0 1500 42

echo "conker-3 low half-life queue complete" | tee -a "$LOG_PATH"
