...
STAMP="$(date +%Y-%m-%d)"
LOG_PATH="$OUT_DIR/conker3_half_life_next_queue_${STAMP}.log"
...
echo "starting conker-3 half-life next queue" | tee "$LOG_PATH"

run_bridge 8 10.0 1500 43
run_bridge 8 10.0 1500 44
run_mixed_quant 16 8.0 1500 42

echo "conker-3 half-life next queue complete" | tee -a "$LOG_PATH"
