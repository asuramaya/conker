...
STAMP="$(date +%F)"
LOG_FILE="$OUT_DIR/conker4b_overlap_probe_queue_${STAMP}.log"
...
run_probe overlap_p1e3 --support-overlap-penalty 0.001
run_probe overlap_p3e3 --support-overlap-penalty 0.003
run_probe overlap_p1e3_t075 --support-overlap-penalty 0.001 --support-gate-temperature 0.75

echo "conker4b overlap probe queue complete" | tee -a "$LOG_FILE"
