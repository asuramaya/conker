...
STAMP="$(date +%Y-%m-%d)"
LOG_PATH="$OUT_DIR/conker3_half_life_queue_${STAMP}.log"
...
echo "starting conker-3 half-life queue" | tee "$LOG_PATH"

run_bridge 16 8.0 1500 42
run_bridge 32 8.0 1500 42
run_bridge 64 8.0 1500 42
run_bridge 128 8.0 1500 42

echo "conker-3 half-life queue complete" | tee -a "$LOG_PATH"
