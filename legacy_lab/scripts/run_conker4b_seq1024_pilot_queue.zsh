...
STAMP="$(date +%F)"
LOG_FILE="$OUT_DIR/conker4b_seq1024_pilot_queue_${STAMP}.log"
...
run_cell gateonly_seq1024_steps1000_bs4 \
  --steps 1000

run_cell gateonly_seq1024_steps1500_bs4 \
  --steps 1500

echo "conker4b seq1024 pilot queue complete" | tee -a "$LOG_FILE"
