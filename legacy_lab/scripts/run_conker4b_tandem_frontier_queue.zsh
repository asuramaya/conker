...
STAMP="$(date +%F)"
LOG_FILE="$OUT_DIR/conker4b_tandem_frontier_queue_${STAMP}.log"
...
echo "starting conker4b tandem frontier queue" | tee "$LOG_FILE"

train_and_full_eval tandem_seq256_steps1500_lr5e4 43 256 16 1500 5e-4
train_and_full_eval tandem_seq256_steps1500_lr5e4 44 256 16 1500 5e-4
train_and_full_eval tandem_seq256_steps1800_lr5e4 42 256 16 1800 5e-4

echo "conker4b tandem frontier queue complete" | tee -a "$LOG_FILE"
