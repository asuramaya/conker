...
LOG="$CONKER/out/conker2_scale_queue_2026-03-25.log"

mkdir -p "$CONKER/out"
echo "starting conker-2 scale queue" | tee "$LOG"
...
for scale in 1.25 1.5 1.75 2.0; do
  run_cell "$scale" 42
done

echo "conker-2 scale queue complete" | tee -a "$LOG"
