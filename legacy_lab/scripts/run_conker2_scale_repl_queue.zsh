...
LOG="$CONKER/out/conker2_scale_repl_queue_2026-03-25.log"

mkdir -p "$CONKER/out"
echo "starting conker-2 scale replication queue" | tee "$LOG"
...
echo "conker-2 scale replication queue complete" | tee -a "$LOG"
