...
- this is inherited historical handoff material from the Conker-side substrate
- it is preserved for chronology and forensic context, not as the active BLINX public read
- start with [Presentation](../docs/presentation.md), [Rescue](../docs/rescue.md), and [Detailed BLINX Notes](./docs/README.md) before using this file as current truth
...
- [CONKER6.md](https://github.com/asuramaya/conker/blob/main/conker/docs/CONKER6.md)
- [conker6.py](https://github.com/asuramaya/conker/blob/main/conker/src/conker6.py)
- [run_conker6_golf_bridge.py](https://github.com/asuramaya/conker/blob/main/conker/scripts/run_conker6_golf_bridge.py)
- [audit_conker6_legality.py](https://github.com/asuramaya/conker/blob/main/conker/scripts/audit_conker6_legality.py)
...
- queue:
  [run_conker7_followup_queue.zsh](https://github.com/asuramaya/conker/blob/main/conker/scripts/run_conker7_followup_queue.zsh)
- evaluator:
  [run_conker7_checkpoint_eval.py](https://github.com/asuramaya/conker/blob/main/conker/scripts/run_conker7_checkpoint_eval.py)
- log:
