...
LOG="$CONKER/out/conker2_scale_pilot_queue_2026-03-25.log"

mkdir -p "$CONKER/out"
echo "starting conker-2 higher-scale pilot queue" | tee "$LOG"
...
echo "conker-2 higher-scale pilot queue complete" | tee -a "$LOG"
