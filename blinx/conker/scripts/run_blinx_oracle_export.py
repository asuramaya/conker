...
from conker.src.giddy_up.attack import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export per-position BLINX oracle labels as JSONL.")
    parser.add_argument(
        "paths",
        nargs="*",
...
def main() -> None:
    ...
    summary = {
        "branch": "blinx-oracle-position-export",
