...
STAMP="$(date +%Y-%m-%d)"
LOG_PATH="$OUT_DIR/conker3_window4_next_queue_${STAMP}.log"
...
echo "starting conker-3 window4 next queue" | tee "$LOG_PATH"

run_cell 5.0 1500 43
run_cell 5.0 1500 44
run_cell 8.0 1000 42

echo "conker-3 window4 next queue complete" | tee -a "$LOG_PATH"
