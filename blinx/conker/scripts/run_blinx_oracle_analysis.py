...
from conker.src.giddy_up.oracle import DEFAULT_SCAN_ROOTS, analyze_oracle


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Measure bidirectional uniqueness over local BLINX files.")
    parser.add_argument(
        "paths",
        nargs="*",
        help="Files or directories to scan. Defaults to the core BLINX tree.",
    )
