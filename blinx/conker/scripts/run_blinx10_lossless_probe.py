...
from conker.src.blinx10 import DEFAULT_PHASES, phase_names, roundtrip_ok


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the BLINX-10 scheduled small-branch lossless-compression probe."
    )
