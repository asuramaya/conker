...
from conker.src.blinx3 import roundtrip_ok


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the BLINX-3 pair-coded rulebook probe.")
    ...
    parser.add_argument("--candidate-radii", default="1,2,3,4")
    parser.add_argument("--pair-rule-budget", type=int, default=128)
...
def main() -> None:
    ...
    compressed, ok = roundtrip_ok(
        ...
        pair_rule_budget=args.pair_rule_budget,
    )
