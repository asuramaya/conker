...
from giddy_up.attack import analyze_oracle_attack
from giddy_up.oracle import DEFAULT_SCAN_ROOTS


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Attack oracle claims with leave-one-out, left-only, and rulebook-cost audits.")
    parser.add_argument("paths", nargs="*", help="Files or directories to scan. Defaults to the local giddy-up repo surface.")
